...
export default function HolidayModal({ isOpen, onClose, onUpdate }: HolidayModalProps) {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      // Only close if DatePicker is NOT open to prevent double-closing confusion
  ...
  return (
    <>
      {/* Main Modal Backdrop 
        We use z-[50]. The DatePicker usually has a higher Z-index or sits outside.
      */}
      <div 
            ...
            <div className="p-6 flex-1 overflow-y-auto custom-scrollbar space-y-6">
              ...
              <form onSubmit={handleAdd} className="bg-black/20 p-4 rounded-xl border border-white/5 space-y-4">
                ...
                <div>
                  ...
                  >
                    <span className="text-sm font-mono">{date ? formatJalali(date) : "انتخاب تاریخ..."}</span>
              ...
              <div className="space-y-3">
                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider">لیست تعطیلات</h4>
      ...
      {/* DatePicker Overlay - Rendered as a sibling to the modal backdrop.
        This ensures clicks on it don't propagate to the HolidayModal backdrop.
      */}
      {showDatePicker && (
        <DatePicker 
          value={date} 
