...
interface MoveConfirmationSheetProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function MoveConfirmationSheet({
  isOpen,
  onClose,
  onConfirm,
  originalEvent,
  newStartTime
}: MoveConfirmationSheetProps) {
  ...
  return (
    <>
      <BottomSheet isOpen={isOpen} onClose={onClose} title="تایید جابجایی">
        <div className="space-y-6 pb-6">
          <div className="text-center space-y-1">
            <p className="text-sm text-gray-400">
                آیا زمان جدید برای <span className="text-blue-400 font-bold">"{originalEvent.title}"</span> صحیح است؟
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-xs text-gray-500 font-bold px-1">تاریخ جدید</label>
              <button 
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="text-xs text-gray-500 font-bold px-1">شروع</label>
                <button 
              ...
              <div className="space-y-1">
                <label className="text-xs text-gray-500 font-bold px-1">پایان</label>
                <button 
